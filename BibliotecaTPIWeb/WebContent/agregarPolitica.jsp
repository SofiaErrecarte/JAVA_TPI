...
<div class="form-group">
  ...
  <input id="numsocio" name="numsocio" type="number" placeholder="Cant libros Socio" class="form-control input-md" required>
</div>
...
<div class="form-group">
  ...
  <input id="numnosocio" name="numnosocio" type="number" placeholder="Cant de Libros No socio" class="form-control input-md" required>
</div>

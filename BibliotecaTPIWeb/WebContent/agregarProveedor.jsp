...
<div class="form-group">
  ...
  <input id="razonSocial" name="razonSocial" pattern="[A-Za-z ]{1,50}" title="No utilices caracteres especiales. Máximo 50 caracteres" type="text" placeholder="Razon Social" class="form-control input-md" required>
